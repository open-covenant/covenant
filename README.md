...
The incubating
[Covenant Timeline integration](./docs/covenant-timeline.md) translates these
existing audit, provenance, capability, and receipt surfaces into a portable
temporal-contract protocol. Covenant will contain the adapter, not a fork of the
standalone reducer.
