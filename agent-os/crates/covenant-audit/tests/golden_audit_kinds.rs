...
const EXPECTED_KINDS: &[&str] = &[
    ...
    "ace_data_generation",
    "peer_enrolled",
    "peer_enrollment_rejected",
    "spend_authorization_decided",
    "spend_settled",
    "escrow_completion_proven",
    "escrow_released",
];
...
fn audit_kind_slug(kind: &AuditKind) -> &'static str {
    match kind {
        ...
        AuditKind::AceDataGeneration { .. } => "ace_data_generation",
        AuditKind::PeerEnrolled { .. } => "peer_enrolled",
        AuditKind::PeerEnrollmentRejected { .. } => "peer_enrollment_rejected",
        AuditKind::SpendAuthorizationDecided { .. } => "spend_authorization_decided",
        AuditKind::SpendSettled { .. } => "spend_settled",
        AuditKind::EscrowCompletionProven { .. } => "escrow_completion_proven",
        AuditKind::EscrowReleased { .. } => "escrow_released",
    ...
    vec![
        ...
        event(
            ...
            AuditKind::AceDataGeneration {
                agent_id: "research@agent".into(),
                tool: "acedata.image".into(),
                model: "ace-diffusion-xl".into(),
                prompt_sha256: hash_hex(b"acedata-prompt"),
                output_sha256: hash_hex(b"acedata-output"),
                assets: vec!["ar://asset-1".into()],
                task_id: Some("task-ace-1".into()),
            },
        ),
        event(
            43,
            AuditKind::PeerEnrolled {
                display: "bob@host2".into(),
                pubkey_b58: "3yZe7d8mUS517G5965aydkZ46HS38QLi7UQiSojurfbQ".into(),
        ...
        event(
            ...
            AuditKind::PeerEnrollmentRejected {
                peer_display: "mallory@host3".into(),
                peer_pubkey_b58: "9xQe7d8mUS517G5965aydkZ46HS38QLi7UQiSojurZZZ".into(),
            },
        ),
        event(
            45,
        ...
        event(
            ...
            AuditKind::EscrowCompletionProven {
                proof_id: Uuid::from_u128(0x5E11_1ED0_0000_0000_0000_0000_0000_0005),
                escrow_id: "escrow-001".into(),
                job_id: Uuid::from_u128(0x5E11_1ED0_0000_0000_0000_0000_0000_0006),
                ...
                result_hash_hex: hash_hex(b"escrow-result"),
                validation_passed: true,
                audit_root_hex: hash_hex(b"escrow-audit-root"),
                signature_b58: "2Zq7Xs9wV3kLp8mNc1bR4tYd6uHf".into(),
            },
        ),
        event(
            48,
            AuditKind::EscrowReleased {
                ...
                receipt_id: Uuid::from_u128(0x5E11_1ED0_0000_0000_0000_0000_0000_0007),
                escrow_id: "escrow-001".into(),
                hirer_address: "Hirer111111111111111111111111111111111111".into(),
                worker_address: "Worker11111111111111111111111111111111111".into(),
                amount: "10.00".into(),
