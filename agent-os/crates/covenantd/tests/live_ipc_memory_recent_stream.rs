...
//! `Server::stream_recent_memory` (lib.rs:6288) by the dispatch fork at
//! lib.rs:2324-2333. That orchestrator calls `self.recent_memory(...)` which
//! gates on `memory.read` via `check_capabilities_any_of` (lib.rs:5757):
//!
