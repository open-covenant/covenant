...
run node ./scripts/validate-peers-rotate-side-effect-comment-line-refs.mjs
...
run node ./scripts/validate-memory-compact-dry-run-default-line-refs.mjs
...
run node ./scripts/validate-ipc-http-doc-stream-envelope.mjs
run node ./scripts/validate-ipc-http-doc-agent-event.mjs
...
run node ./scripts/validate-audit-integrity-doc-tool-call-outcome.mjs
