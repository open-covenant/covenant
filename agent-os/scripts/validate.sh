...
run node ./scripts/validate-autonomy-review-artifacts.mjs
run node ./scripts/validate-review-signing-readiness.mjs
...
run node ./scripts/validate-gvisor-runner-promotion-readiness.mjs
...
run node ./scripts/validate-ipc-http-gateway-v2-fixture-contract.mjs
