 ...
 * says which field moved. The multi-hop vector was checked against the router on
 * 4663: the same layout passes `eth_call` for a USDG to SPY to PAIR route from a
 * funded account, and the mainline v4 layout reverts.
 */
...
const MULTI_HOP_CALLDATA =
  '';
...
describe('encodeV4Swap, one pool', () => {
  ...
  it('lays the single swap out the way the router on 4663 decodes it', () => {
    ...
    // zeroForOne, amountIn, amountOutMinimum, minHopPriceX36 = 0, then the
  ...
  it('writes one path entry per hop, each naming the currency it lands in', () => {
    ...
    const [swap] = decodeAbiParameters(
    ...
    ) as unknown as [
      {
        ...
        minHopPriceX36: readonly bigint[];
        amountIn: bigint;
        amountOutMinimum: bigint;
      },
    ];
    ...
    expect(swap.minHopPriceX36).toHaveLength(0);
    expect(swap.amountIn).toBe(AMOUNT_IN);
