...
| Settlement receipts and chain gates | Covered | daemon dispatch writes and reads receipts after `chain.receipts` grant | Live CLI receipt-read coverage for scoped grants once JSON receipt output stabilizes. |
