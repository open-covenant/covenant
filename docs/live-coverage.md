...
| Settlement receipts and chain gates | Covered | daemon dispatch writes/reads receipts after `chain.receipts`, CLI `receipts recent --json` | Scoped receipt filter coverage once receipt query predicates become user-selectable. |
