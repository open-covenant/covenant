...
2. `covenant.release-scope.v1` release scope manifest — this document. Generated by `agent-os/scripts/build-release-scope-manifest.mjs`; signing by the release-artifacts workflow is still pending.
