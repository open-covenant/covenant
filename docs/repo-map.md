...
| `agent-os/scripts` | Validation, live coverage checks, identity and settlement receipt provenance dry-runs, A2A peer repair reports, autonomy summaries, provenance verification, test inventory, handoff, and regression guards. |
