...
|---|---|---|
| `@covenant-org/sdk` | Published to npm (v0.2.0) | Root export map, TypeScript declarations, `packages/sdk/compatibility/exports.v1.json`, and `packages/sdk/compatibility/instructions.v1.json` are validated. |
