  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>Keeps distributed settlement, installers, additional-language SDK publication (Python, Rust-crate), release-scope and audit-root signing, and transparency publication as planned work until implemented.</li>
      </ul>
