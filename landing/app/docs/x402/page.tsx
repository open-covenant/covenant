...
export default function X402Page() {
  return (
    <>
      ...
      <p>
        The current daemon path can route a call through capability-gated MCP tools, but it cannot
        reliably distinguish a free first-response success from a paid retry and records the
        caller-configured per-call cap rather than the selected live amount. Its local budget,
        receipt, and audit rows are not chain-settlement evidence. The legacy capability matches
        network, asset, and maximum amount; it does not bind trusted <code>payTo</code>, endpoint,
        scheme, fee payer, or redirects, so this is not production W009 enforcement.
      </p>
      <p>
