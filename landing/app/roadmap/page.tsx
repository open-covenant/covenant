...
const MILESTONES: Milestone[] = [
  {
    ...
    bullets: [
      ...
      "Append-only workflow records and commit-scoped provenance for recorded privileged actions; coverage depends on callers emitting events and does not prove runtime mediation or log completeness",
      ...
      "Solana mainnet identity and an MPL Core AppData audit-root commitment, with configured DAS/RPC structural checks that do not prove the underlying work",
      ...
      "Experimental Base mainnet identity metadata under ERC-8004, plus deployed contract, EAS schema, and ENS records; these separate observations do not establish Solana interoperability, reputation, funded bonds, or runtime enforcement, and $CVNT never leaves Solana",
  ...
  },
  {
    ...
    bullets: [
      ...
      "SDKs published to PyPI and crates.io",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Research a cross-chain bond-adjudication design with an objective fault proof and challenge window before considering any Solana slashing path",
    ],
  },
  {
    code: "M4",
