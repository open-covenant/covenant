...
export const covenantBrand = Object.freeze({
  ...
  networkTagline: 'Agent-native operating infrastructure with CVNT credits, staking, and receipt anchoring on Solana.',
  ...
  token: Object.freeze({
    ...
    symbol: process.env.NEXT_PUBLIC_COVENANT_TOKEN_SYMBOL ?? process.env.COVENANT_TOKEN_SYMBOL ?? 'CVNT',
    decimals: toNumber(
