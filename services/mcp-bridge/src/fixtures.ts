// Local demo fixtures. Kept out of the published @covenant-org/sdk (production SDK ships no mock data).
import type { SolanaAddress, Hash32, TaskStatus } from '@covenant-org/sdk';
import { hash32FromText } from '@covenant-org/sdk';

const COVENANT_TOKEN_SYMBOL = 'CVNT';
