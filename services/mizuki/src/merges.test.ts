...
const quote: Quote = {
  ...
  authorizationReceipt: {
    ...
    permission: 'maintain',
    authorizedAt: '2026-08-22T09:00:00.000Z',
    verifiedAt: '2026-08-22T09:00:01.000Z',
...
function discharged(): RefundLiability {
  return {
    ...
    baseRef: 'main',
    baseSha: 'a'.repeat(40),
    repositoryAuthorizedAt: '2026-08-22T09:00:00.000Z',
    authorizationEvidenceHash: 'c'.repeat(64),
    reviewedHeadSha: 'b'.repeat(40),
    reviewedBaseSha: 'a'.repeat(40),
    reviewedBaseRef: 'main',
    reviewedDiffHash: 'f'.repeat(64),
    deliveryBoundAt: '2026-08-22T10:00:00.000Z',
    deliveryBindingHash: 'd'.repeat(64),
    payer: 'customer',
    treasury: 'treasury',
